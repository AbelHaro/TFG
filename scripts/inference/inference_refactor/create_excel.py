...
def create_excel(times, total_frames, file="times.csv"):
    ...
    with open(output_excel_file, 'w', newline='') as csvfile:
        ...
        writer.writerow(["Frame", "Captura", "Procesamiento", "Tracking", "Escritura", "Cantidad Objetos", "Tiempo Total(ms)", "Tiempo por Objeto tracking(ms)", "FPS", "Preprocess", "Inference", "Postprocess"])
