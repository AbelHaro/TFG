...
def main():
    ...
    results_path = 'runs/comparative_inference'
    ...
    for path_640, path_1080, path_label in image_sets:
        ...
        # Guardar resultados
        results_dir = os.path.join(results_path, set_id)
        ...
        all_results[set_id] = {
            ...
            'ground_truth_640': ground_truth_boxes_640,
            'ground_truth_1080': ground_truth_boxes_1080,
            'image_shape': image_1080.shape[:2]  # (height, width)
        }
        
        # Guardar resultados en formato numpy para análisis posterior
        np.save(os.path.join(results_dir, 'results.npy'), all_results[set_id])
