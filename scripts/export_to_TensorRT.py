...
for model_name in models_name:
    ...
    video_path = "../datasets_labeled/2024_11_28_canicas_dataset/val/images"  # Asegúrate de que esta ruta sea válida

    # Realizar inferencia en el video
    results = tensorrt_model.val(source=video_path, project=output_dir)  # Asegúrate de que el método predict sea el adecuado
