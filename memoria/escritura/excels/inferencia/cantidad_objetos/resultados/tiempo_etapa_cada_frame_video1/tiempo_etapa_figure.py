...
data = pd.read_csv("./tiempo_etapa_cada_frame_video1.csv")
...
plt.title(r"Tiempos de etapa en cada frame del video 1")
...
plt.savefig("tiempo_etapa_video1.pdf", bbox_inches="tight")
