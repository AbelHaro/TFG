...
x = np.arange(len(data["Precision"]))
width = 0.6
...
plt.title(r"Comparaci\'on de tiempos de inferencia por precisi\'on", pad=20)
plt.xlabel(r"Tipo de precisi\'on")
plt.ylabel(r"Tiempo (ms)")

# Configurar las etiquetas del eje x
plt.xticks(x, data["Precision"], rotation=0)
...
plt.savefig("tiempos_inferencia_device.pdf", bbox_inches="tight")
