...
\pgfplotsset{compat=1.16} % Set compatibility for pgfplots
...
\hypersetup{
    ...
    linkcolor=black, 
    urlcolor=cyan,
    pdftitle={Detección de defectos en objetos en movimiento mediante Redes Neuronales Convolucionales con optimizaciones específicas para hardware NVIDIA},
    pdfauthor={Haro Armero, Abel},
    pdfsubject={Trabajo de Fin de Grado -- Ingeniería Informática},
    pdfkeywords={Redes Neuronales Convolucionales, Detección de defectos, Visión por computador, NVIDIA Jetson, Tiempo real, Optimización energética, CNN, Computer Vision, Deep Learning, YOLO, TensorRT},
...
\newacronym[plural={AIs}, firstplural={Inteligencias Artificiales (AIs)}]{ai}{IA}{Inteligencia Artificial}
...
\newacronym[plural={IDF1s}]{idf1}{IDF1}{ID F1 Score}
\newacronym[plural={HOTAs}]{hota}{HOTA}{Higher Order Tracking Accuracy}
...
\begin{table}[H]
   ...
   \begin{tabular}{l | c | c | c | c | c | c | c }
      ...
      \midrule
      Jetson AGX Orin & 275 TOPS & \begin{tabular}[c]{@{}c@{}}2048-core Ampere,\\64 Tensor Cores\end{tabular} & 1.3 GHz & \begin{tabular}[c]{@{}c@{}}12-core Cortex-A78AE,\\3MB L2 + 6MB L3,\\2.2 GHz\end{tabular} & \begin{tabular}[c]{@{}c@{}}64GB LPDDR5,\\204.8GB/s\end{tabular} & 2x NVDLA v2 & 2400 \\
      \midrule
      Jetson Orin Nano & 67 TOPS & \begin{tabular}[c]{@{}c@{}}1024-core Ampere,\\32 Tensor Cores\end{tabular} & 1020 MHz & \begin{tabular}[c]{@{}c@{}}6-core Cortex-A78AE,\\1.5MB L2 + 4MB L3,\\1.7 GHz\end{tabular} & \begin{tabular}[c]{@{}c@{}}8GB LPDDR5,\\102 GB/s\end{tabular} & - & 300 \\
      \midrule
      Jetson AGX Xavier & 32 TOPS & \begin{tabular}[c]{@{}c@{}}512-core Volta,\\64 Tensor Cores\end{tabular} & 1377 MHz & \begin{tabular}[c]{@{}c@{}}8-core Carmel v8.2,\\8MB L2 + 4MB L3,\\2.2 GHz\end{tabular} & \begin{tabular}[c]{@{}c@{}}32GB LPDDR4x,\\136.5GB/s\end{tabular} & 2x NVDLA v1 & 1000 \\
      \bottomrule
   \end{tabular}
   }
...
\begin{figure}[h]
   ...
   \caption[Diagrama de flujo del sistema segmentado en hilos]{Diagrama de flujo del sistema segmentado en hilos.}
   \label{fig:hilos}
...
\begin{table}[H]
   ...
   \pgfplotstabletypeset[
       ...
       display columns/0/.style={column name=\begin{tabular}[c]{@{}c@{}}Cant. \\ Objetos\end{tabular}, column type={c}, string type},
       display columns/1/.style={column name=\begin{tabular}[c]{@{}c@{}}Frames \\ Procesados\end{tabular}, column type={c}},
       display columns/2/.style={column name=\begin{tabular}[c]{@{}c@{}}Tiempo \\ Ejec. (s) $\downarrow$\end{tabular}, column type={c}},
       display columns/3/.style={column name=FPS $\uparrow$, column type={c}},
       display columns/4/.style={column name=LFPS $\downarrow$, column type={c}, fixed, precision=2},
       display columns/5/.style={column name=\begin{tabular}[c]{@{}c@{}}Potencia \\ media (W) $\downarrow$\end{tabular}, column type={c}, fixed, precision=2},
       display columns/6/.style={column name=\begin{tabular}[c]{@{}c@{}}Energía \\ (J) $\downarrow$\end{tabular}, column type={c}, fixed, precision=0},
       display columns/7/.style={column name=Frames/W $\uparrow$, column type={c}},
       display columns/8/.style={column name=\begin{tabular}[c]{@{}c@{}}GPU \\ Avg. (\%) $\downarrow$\end{tabular}, column type={c}},
       display columns/9/.style={column name=\begin{tabular}[c]{@{}c@{}}CPU \\ Avg. (\%) $\downarrow$\end{tabular}, column type={c}},
...
\begin{table}[H]
   ...
   \pgfplotstabletypeset[
       ...
       display columns/0/.style={column name=\begin{tabular}[c]{@{}c@{}}Modo de\\Segmentación\end{tabular}, column type={c}, string type,
            string replace={multiprocesos memoria compartida}{\begin{tabular}[c]{@{}c@{}}multiprocesos\\memoria compartida\end{tabular}}},
       display columns/1/.style={column name=\begin{tabular}[c]{@{}c@{}}Frames\\Procesados $\uparrow$\end{tabular}, column type={c}, fixed, precision=0},
       display columns/2/.style={column name=\begin{tabular}[c]{@{}c@{}}Tiempo\\Ejec. (s) $\downarrow$\end{tabular}, column type={c}, fixed, precision=2},
       display columns/3/.style={column name=FPS $\uparrow$, column type={c}, fixed, precision=2},
       display columns/4/.style={column name=LFPS $\downarrow$, column type={c}, fixed, precision=2},
       display columns/5/.style={column name=\begin{tabular}[c]{@{}c@{}}Potencia\\media (W) $\downarrow$\end{tabular}, column type={c}},
       display columns/6/.style={column name=\begin{tabular}[c]{@{}c@{}}Energía\\(J) $\downarrow$\end{tabular}, column type={c}},
       display columns/7/.style={column name=Frames/W $\uparrow$, column type={c}, fixed, precision=2},
       display columns/8/.style={column name=Speedup $\uparrow$, column type={c}, fixed, precision=2},
       display columns/9/.style={column name=\begin{tabular}[c]{@{}c@{}}GPU Avg.\\[0.1ex] \protect\footnotemark $\downarrow$\end{tabular}, column type={c}},
...
\footnotetext{\footnotesize En la configuración de segmentación heterogénea, se utilizan la GPU y los dos núcleos DLA; sin embargo, solo se muestra la utilización de la GPU, ya que la herramienta de monitorización de NVIDIA no reporta la utilización media de la DLA.}
...
\begin{table}[H]
   ...
   \pgfplotstabletypeset[
       col sep=comma,
       header=true,
       columns={modo_segmentacion,frames_procesados,tiempo_ejecucion_s,FPS,LFPS,potencia_media_consumida_W,energia_consumida_J,frames_por_W},
       display columns/0/.style={column name=\begin{tabular}[c]{@{}c@{}}Modo de\\Segmentación\end{tabular}, column type={c}, string type,
            string replace={multiprocesos memoria compartida}{\begin{tabular}[c]{@{}c@{}}multiprocesos\\memoria compartida\end{tabular}}},
       display columns/1/.style={column name=\begin{tabular}[c]{@{}c@{}}Frames\\Procesados $\uparrow$\end{tabular}, column type={c}, fixed, precision=0},
       display columns/2/.style={column name=\begin{tabular}[c]{@{}c@{}}Tiempo\\Ejec. (s) $\downarrow$\end{tabular}, column type={c}, fixed, precision=2},
   ...
   \caption[Resultados del experimento con distintos tipos de segmentación a 30 fps]{Resultados del experimento con distintos tipos de segmentación a 30 fps.}
...
\begin{table}[H]
   ...
   \pgfplotstabletypeset[
       ...
       display columns/3/.style={column name=FPS $\uparrow$, column type={c}, fixed, precision=2},
       display columns/4/.style={column name=LFPS $\downarrow$, column type={c}, fixed, precision=2},
       display columns/5/.style={column name=\begin{tabular}[c]{@{}c@{}}Potencia\\media (W) $\downarrow$\end{tabular}, column type={c}, fixed, precision=3},
       display columns/6/.style={column name=\begin{tabular}[c]{@{}c@{}}Energía\\(J) $\downarrow$\end{tabular}, column type={c}, fixed, precision=2},
       display columns/7/.style={column name=Frames/W $\uparrow$, column type={c}, fixed, precision=2},
       display columns/8/.style={column name=\begin{tabular}[c]{@{}c@{}}GPU\\Avg. (\%) $\downarrow$\end{tabular}, column type={c}, fixed, precision=2},
       display columns/9/.style={column name=\begin{tabular}[c]{@{}c@{}}CPU\\Avg. (\%) $\downarrow$\end{tabular}, column type={c}, fixed, precision=2},
       display columns/10/.style={column name=\begin{tabular}[c]{@{}c@{}}T. Prepro.\\(ms) $\downarrow$\end{tabular}, column type={c}, fixed, precision=2},
...
\begin{table}[H]
   ...
   \pgfplotstabletypeset[
      ...
      %  display columns/12/.style={column name=T. Postpro. (ms), column type={c}, fixed, precision=2},
       display columns/8/.style={column name={mAP$_{50-95}$ $\uparrow$}, column type={c}, fixed, precision=2},
       every head row/.style={before row=\toprule, after row=\midrule},
       every last row/.style={after row=\bottomrule},
       empty cells with={NaN}
   ]{excels/inferencia/modelo_talla/data/30_fps.csv}
   }
   \caption[Resultados del experimento con distintos modelos y tallas a 30 fps]{Resultados del experimento con distintos modelos y tallas a 30 fps.}
...
\begin{table}[H]
   ...
   \pgfplotstabletypeset[
      ...
      display columns/2/.style={column name=\begin{tabular}[c]{@{}c@{}}Frames\\Procesados $\uparrow$\end{tabular}, column type={c}, fixed, precision=0},
      display columns/3/.style={column name=\begin{tabular}[c]{@{}c@{}}Tiempo\\Ejec. (s)  $\downarrow$\end{tabular}, column type={c}, fixed, precision=2},
      display columns/4/.style={column name=FPS $\uparrow$, column type={c}, fixed, precision=2},
      display columns/5/.style={column name=LFPS $\downarrow$, column type={c}, fixed, precision=2},
      display columns/6/.style={column name=\begin{tabular}[c]{@{}c@{}}Potencia\\media (W) $\downarrow$\end{tabular}, column type={c}, fixed, precision=3},
      display columns/7/.style={column name=\begin{tabular}[c]{@{}c@{}}Energía\\(J) $\downarrow$\end{tabular}, column type={c}, fixed, precision=2},
      display columns/8/.style={column name=Frames/W $\uparrow$, column type={c}, fixed, precision=2},
...
\begin{table}[H]
   ...
   \pgfplotstabletypeset[
      ...
      display columns/0/.style={column name=\begin{tabular}[c]{@{}c@{}}Modo de \\ Energía\end{tabular}, column type={c}, string type},
      display columns/1/.style={column name=\begin{tabular}[c]{@{}c@{}}Núcleos \\ de CPU\end{tabular}, column type={c}, string type},
      display columns/2/.style={column name=\begin{tabular}[c]{@{}c@{}}Frecuencia \\ (GHz)\end{tabular}, column type={c}, fixed, precision=2},
      display columns/3/.style={column name=\begin{tabular}[c]{@{}c@{}}Frames \\ Procesados $\uparrow$\end{tabular}, column type={c}, fixed, precision=0},
      display columns/4/.style={column name=\begin{tabular}[c]{@{}c@{}}Tiempo \\ Ejec. (s) $\downarrow$\end{tabular}, column type={c}, fixed, precision=2},
      display columns/5/.style={column name=FPS $\uparrow$, column type={c}, fixed, precision=2},
      display columns/6/.style={column name=LFPS $\downarrow$, column type={c}, fixed, precision=2},
      display columns/7/.style={column name=\begin{tabular}[c]{@{}c@{}}Potencia \\ media (W) $\downarrow$\end{tabular}, column type={c}, fixed, precision=3},
      display columns/8/.style={column name=\begin{tabular}[c]{@{}c@{}}Energía \\ (J) $\downarrow$\end{tabular}, column type={c}, fixed, precision=2},
      display columns/9/.style={column name=Frames/W $\uparrow$, column type={c}, fixed, precision=2},
      display columns/10/.style={column name=\begin{tabular}[c]{@{}c@{}}GPU \\ Avg. (\%) $\downarrow$\end{tabular}, column type={c}, fixed, precision=2},
...
\begin{table}[H]
   ...
   \pgfplotstabletypeset[
      col sep=comma,
      header=true,
      columns={dispositivo,processed_frame,execution_time,fps,lfps,average_power_consuption,energy_consuption,frames/w,average_gpu,average_cpu,Tpreprocesado,Tinferencia,Tpostprocesado},
      display columns/0/.style={column name=Dispositivo, column type={c}, string type},
      display columns/1/.style={column name=\begin{tabular}[c]{@{}c@{}}Frames\\Procesados $\uparrow$\end{tabular}, column type={c}, fixed, precision=0},
      display columns/2/.style={column name=\begin{tabular}[c]{@{}c@{}}Tiempo\\Ejec. (s) $\downarrow$\end{tabular}, column type={c}, fixed, precision=2},
      display columns/3/.style={column name=FPS $\uparrow$, column type={c}, fixed, precision=2},
      display columns/4/.style={column name=LFPS $\downarrow$, column type={c}, fixed, precision=2},
...
\begin{itemize}
   \item \textbf{Motor de corriente continua (DC) de 12V y 319 RPM:} Seleccionado por su capacidad para proporcionar un movimiento constante y controlable de la banda transportadora. Las especificaciones de voltaje permiten una alimentación sencilla mediante fuentes estándar, mientras que la velocidad de rotación es adecuada para el transporte de objetos pequeños como las canicas utilizadas en las pruebas.
   
   \item \textbf{Filamento PLA (ácido poliláctico):} Material utilizado para la impresión 3D de las piezas estructurales de la cinta. Su elección se debe a su facilidad de impresión, resistencia mecánica suficiente para la aplicación, y su bajo coste. Las piezas impresas incluyen los soportes de rodamientos, las poleas de transmisión y los elementos de guiado de la banda.
   
   \item \textbf{Cuatro rodamientos de tipo 688ZZ:} Rodamientos de bolas con blindaje metálico que facilitan el movimiento suave y de baja fricción de los ejes rotativos. Sus dimensiones compactas (8mm de diámetro interior, 16mm de diámetro exterior y 5mm de ancho) los hacen ideales para aplicaciones de precisión en espacios reducidos.
   
   \item \textbf{Servomotor DS3225:} Actuador de alta precisión encargado de accionar el mecanismo de rechazo de canicas defectuosas. Este servomotor ofrece un torque de 20 kg$\cdot$cm y una precisión angular de $\pm$1°, características que garantizan un posicionamiento preciso y repetible del mecanismo de desviación.
   
   \item \textbf{Banda transportadora:} Cinta de 7.5 cm de ancho y 1.2 m de longitud, fabricada en material sintético con superficie texturizada para evitar el deslizamiento de los objetos transportados. Su flexibilidad permite adaptarse a las poleas sin deformación permanente.
   
   \item \textbf{Correa de sincronización GT2:} Correa dentada de 300 mm de longitud y 6 mm de ancho, utilizada para la transmisión de potencia entre el motor y las poleas principales. Su diseño dentado previene el deslizamiento y garantiza una transmisión de movimiento sincronizada.
   
   \item \textbf{Raspberry Pi Pico WH:} Microcontrolador de bajo coste basado en el chip RP2040 de doble núcleo ARM Cortex-M0+. Incorpora conectividad WiFi integrada y pines GPIO preconfigurados, lo que facilita tanto la programación como las conexiones eléctricas necesarias para el control del servomotor.
   
   \item \textbf{Cámara USB:} Dispositivo de captura de imágenes con resoluciones variables y capacidad de grabación a 30 fps.

   \item \textbf{Componentes auxiliares:} Incluyen cableado de diferentes calibres para las conexiones de potencia y señal, tornillería métrica M3 y M4 para el ensamblaje de componentes, y elementos de fijación para el montaje de la estructura sobre la superficie de trabajo.
   
   \item \textbf{Fuente de alimentación regulada:} Fuente switching de 12V/3A para el suministro de energía al motor DC y demás componentes electrónicos, con protecciones contra sobrecorriente y cortocircuito.
\end{itemize}
...
Como complemento, la Raspberry Pi Pico WH se programó específicamente para controlar el servomotor que desvía las canicas identificadas como defectuosas. Esta separación de responsabilidades permite que el sistema de actuación responda con latencia mínima, mientras que el Jetson puede dedicar todos sus recursos al procesamiento de visión artificial sin interrupciones por tareas de control de hardware.
...
Para la prueba de concepto, se utilizaron canicas de vidrio de colores como objetos de prueba, una elección que ofrece varias ventajas metodológicas. Las canicas proporcionan una forma geométrica consistente y predecible, lo que facilita la evaluación de la precisión de detección sin las variables introducidas por objetos irregulares. Además, su superficie lisa y reflectante permite evaluar la robustez del sistema ante diferentes condiciones de iluminación y reflexión.

El protocolo experimental incluyó la preparación de dos conjuntos diferenciados de canicas: un conjunto de canicas ``válidas'' consistente en canicas de color blanco uniforme sin defectos visibles, y un conjunto de canicas ``defectuosas'' que presentaban manchas rojas artificiales aplicadas de forma controlada. Esta mancha roja constituye el criterio de clasificación principal utilizado para identificar las canicas defectuosas, simulando defectos de calidad que podrían encontrarse en un entorno industrial real.

Las pruebas se ejecutaron en sesiones de 30 minutos cada una, con diferentes configuraciones de velocidad de la cinta transportadora (15, 20 y 25 cm/s) para evaluar el rendimiento del sistema bajo distintas condiciones operativas. Se registraron métricas cuantitativas como la tasa de detección correcta, los falsos positivos y negativos, el tiempo de respuesta del sistema de actuación, y la precisión del mecanismo de rechazo.
