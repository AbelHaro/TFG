...
\section{Metodología de evaluación y métricas de rendimiento}
...
\begin{figure}[H]
   \centering
   \includegraphics[width=0.6\textwidth]{images/analisis_de_la_solucion/variación_de_objetos_en_el_vídeo.png}
   \caption{Número de objetos en el vídeo de prueba.}
   \label{fig:variacion_objetos}
\end{figure}

La Figura \ref{fig:variacion_objetos} muestra la variación del número de objetos en el vídeo de prueba. Esta variación es importante para evaluar el rendimiento del sistema, ya que un mayor número de objetos puede aumentar la carga computacional y afectar el tiempo de procesamiento.
...
\begin{itemize}
   ...
   \item \textbf{Potencia consumida (W):} Mide la potencia eléctrica instantánea consumida por el sistema durante la ejecución. Es crucial para evaluar la eficiencia energética.
   ...
   \item \textbf{Fotogramas por vatio (Frames/W):} Indica cuántos fotogramas se procesan por cada vatio de potencia consumido. Esta métrica es útil para evaluar la eficiencia del sistema en términos de rendimiento por unidad de energía.
