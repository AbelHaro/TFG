...
\begin{itemize}
   ...
   \item Una banda transportadora de 7.5 cm de ancho y 1.2 m de largo.
...
El sistema completo se configuró de la siguiente manera: el procesamiento principal, incluyendo la ejecución del modelo de detección de objetos, se realiza en un dispositivo NVIDIA Jetson AGX Xavier. Este dispositivo es el encargado de analizar las imágenes capturadas por la cámara y ejecutar los algoritmos de visión artificial necesarios para la identificación y clasificación de las canicas.

Para la comunicación entre el Jetson AGX Xavier y la Raspberry Pi Pico WH, se establece una conexión TCP/IP que permite el intercambio de información en tiempo real. Al iniciar el sistema, el Jetson AGX Xavier actúa como servidor, abriendo un socket en el puerto 5000 y esperando la conexión de la Raspberry Pi Pico WH, que funciona como cliente. Una vez que la Raspberry Pi Pico WH se conecta exitosamente, envía un mensaje de inicio al Jetson para confirmar que está lista para recibir comandos. A partir de este momento, el Jetson comienza a procesar el flujo de vídeo de la cámara de manera continua.

Durante el funcionamiento del sistema, cuando el modelo de detección ejecutándose en el Jetson identifica una canica defectuosa basándose en los criterios de clasificación establecidos, envía inmediatamente un mensaje específico a la Raspberry Pi Pico WH a través de la conexión TCP/IP. Al recibir esta señal de activación, la Raspberry Pi Pico WH ejecuta la rutina de rechazo, activando el servomotor DS3225 durante un breve instante controlado. Este accionamiento preciso mueve un mecanismo mecánico que desvía la canica defectuosa fuera de la trayectoria principal de la cinta transportadora, separándola efectivamente del flujo de productos válidos.
...
Para la prueba de concepto, se utilizaron las canicas de colores como objetos de prueba. En la Figura \ref{fig:imagen_prueba_concepto} se muestra un frame de ejemplo de la prueba de concepto, donde se observan tres canicas de color blanco Entre ellas, una canica defectuosa con una mancha roja, que es el criterio de clasificación utilizado para identificar las canicas defectuosas. 
...
\begin{figure}[H]
   ...
   \lstinputlisting[language=python, caption=detection\_tracking\_pipeline.py, label=lst:detection_tracking_pipeline, basicstyle=\footnotesize\ttfamily, breaklines=true, literate={á}{{\'{a}}}1 {é}{{\'{e}}}1 {í}{{\'{i}}}1 {ó}{{\'{o}}}1 {ú}{{\'{u}}}1 {ñ}{{\~{n}}}1 {Á}{{\'{A}}}1 {É}{{\'{E}}}1 {Í}{{\'{I}}}1 {Ó}{{\'{O}}}1 {Ú}{{\'{U}}}1 {Ñ}{{\~{N}}}1 {¡}{{\textexclamdown}}1 {¿}{{\textquestiondown}}1]{codigo/detection_tracking_pipeline.py}
   ...
   \lstinputlisting[language=python, caption=unified\_pipeline.py, label=lst:unified_pipeline, literate={á}{{\'{a}}}1 {é}{{\'{e}}}1 {í}{{\'{i}}}1 {ó}{{\'{o}}}1 {ú}{{\'{u}}}1 {ñ}{{\~{n}}}1 {Á}{{\'{A}}}1 {É}{{\'{E}}}1 {Í}{{\'{I}}}1 {Ó}{{\'{O}}}1 {Ú}{{\'{U}}}1 {Ñ}{{\~{N}}}1 {¡}{{\textexclamdown}}1 {¿}{{\textquestiondown}}1]{codigo/unified_pipeline.py}
   ...
   \lstinputlisting[language=python, caption=tracker\_wrapper.py, label=lst:tracker_wrapper, literate={á}{{\'{a}}}1 {é}{{\'{e}}}1 {í}{{\'{i}}}1 {ó}{{\'{o}}}1 {ú}{{\'{u}}}1 {ñ}{{\~{n}}}1 {Á}{{\'{A}}}1 {É}{{\'{E}}}1 {Í}{{\'{I}}}1 {Ó}{{\'{O}}}1 {Ú}{{\'{U}}}1 {Ñ}{{\~{N}}}1 {¡}{{\textexclamdown}}1 {¿}{{\textquestiondown}}1]{codigo/classes/tracker_wrapper.py}
   ...
   \lstinputlisting[language=python, caption=shared\_circular\_buffer.py, label=lst:shared_circular_buffer, literate={á}{{\'{a}}}1 {é}{{\'{e}}}1 {í}{{\'{i}}}1 {ó}{{\'{o}}}1 {ú}{{\'{u}}}1 {ñ}{{\~{n}}}1 {Á}{{\'{A}}}1 {É}{{\'{E}}}1 {Í}{{\'{I}}}1 {Ó}{{\'{O}}}1 {Ú}{{\'{U}}}1 {Ñ}{{\~{N}}}1 {¡}{{\textexclamdown}}1 {¿}{{\textquestiondown}}1]{codigo/classes/shared_circular_buffer.py}
   ...
   \lstinputlisting[language=python, caption=inference.py, label=lst:inference, basicstyle=\footnotesize\ttfamily, breaklines=true, breakatwhitespace=true, literate={á}{{\'{a}}}1 {é}{{\'{e}}}1 {í}{{\'{i}}}1 {ó}{{\'{o}}}1 {ú}{{\'{u}}}1 {ñ}{{\~{n}}}1 {Á}{{\'{A}}}1 {É}{{\'{E}}}1 {Í}{{\'{I}}}1 {Ó}{{\'{O}}}1 {Ú}{{\'{U}}}1 {Ñ}{{\~{N}}}1 {¡}{{\textexclamdown}}1 {¿}{{\textquestiondown}}1]{codigo/inference.py}
