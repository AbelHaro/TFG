...
\begin{table}[H]
   ...
   \pgfplotstabletypeset[
       ...
       display columns/1/.style={column name=\begin{tabular}[c]{@{}c@{}}Frames\\Procesados\end{tabular}, column type={c}, fixed, precision=0},
       display columns/2/.style={column name=\begin{tabular}[c]{@{}c@{}}Tiempo\\Ejec. (s)\end{tabular}, column type={c}, fixed, precision=2},
