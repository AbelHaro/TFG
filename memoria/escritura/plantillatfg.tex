...
El código fuente del proyecto se encuentra disponible en el repositorio de GitHub del autor, en la siguiente dirección: \url{https://github.com/usuario/proyecto}
...
\begin{figure}[H]
   \centering
   \includegraphics[width=0.7\textwidth]{codigo/images/detection_tracking_pipeline_uml.png}
   ...
   La figura \ref{fig:detection_tracking_pipeline_uml} muestra el diagrama de clases del objeto DetectionTrackingPipeline.
   ...
   La figura \ref{fig:unified_pipeline_uml} muestra el diagrama de clases de objeto UnifiedPipeline.

   \lstinputlisting[language=python, caption=Ejemplo de código Python (desde archivo), label=lst:unified_pipeline, literate={á}{{\'{a}}}1 {é}{{\'{e}}}1 {í}{{\'{i}}}1 {ó}{{\'{o}}}1 {ú}{{\'{u}}}1 {ñ}{{\~{n}}}1 {Á}{{\'{A}}}1 {É}{{\'{E}}}1 {Í}{{\'{I}}}1 {Ó}{{\'{O}}}1 {Ú}{{\'{U}}}1 {Ñ}{{\~{N}}}1 {¡}{{\textexclamdown}}1 {¿}{{\textquestiondown}}1]{codigo/unified_pipeline.py}
