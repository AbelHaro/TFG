...
\begin{table}[H]
   ...
   \pgfplotstabletypeset[
       ...
       display columns/5/.style={column name=\begin{tabular}[c]{@{}c@{}}Potencia\\media (W)\end{tabular}, column type={c}},
       display columns/6/.style={column name=\begin{tabular}[c]{@{}c@{}}Energía\\(J)\end{tabular}, column type={c}},
       ...
       display columns/9/.style={column name=\begin{tabular}[c]{@{}c@{}}GPU Avg.\\[0.1ex] \protect\footnotemark\end{tabular}, column type={c}},
       display columns/10/.style={column name=\begin{tabular}[c]{@{}c@{}}CPU\\Avg.\end{tabular}, column type={c}},
       every head row/.style={before row=\toprule, after row=\midrule},
       every last row/.style={after row=\bottomrule},
       empty cells with={NaN}
