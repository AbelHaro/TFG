...
\usepackage{graphicx}
\usepackage{multimedia}   % Para centrar columnas con @{}
    ...
    \begin{columns}
        \begin{column}{0.45\textwidth}
            \begin{itemize}
                ...
                \item Dispositivos optimizados para IA en entornos embebidos.
...
\begin{frame}{Objetivos}
    \begin{itemize}
        \item Estudiar el estado del arte en CNNs, aceleradores hardware.
        \item Crear un conjunto de datos para entrenamiento y evaluación.
        \item Entrenar y validar diferentes modelos CNN para detección de defectos en tiempo real.
        \item Implementar un sistema de visión artificial integrado con hardware NVIDIA.
        \item Analizar y optimizar cuellos de botella para mejorar rendimiento y consumo energético.
    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            ...
            \begin{itemize}
                ...
                \item $\uparrow$ Permite un procesamiento concurrente, pero con mayor latencia en la comunicación.
                \item $\downarrow$ La comunicación entre procesos se realiza mediante colas implementadas sobre pipes.
        \end{itemize}
        \end{column}
            \begin{column}{0.5\textwidth}
            \begin{center}
    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            ...
            \begin{itemize}
                ...
                \item $\uparrow$ Permite un procesamiento concurrente con menor latencia en la comunicación.
                \item Las colas de comunicación se implementan sobre memoria compartida entre procesos evitando la sobrecarga de pipes.
            \end{itemize}
        \end{column}
        \begin{column}{0.5\textwidth}
                \begin{center}
    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            ...
            \begin{itemize}
                ...
                \item $\uparrow$ Teóricamente permite explotar todos los recursos para mejorar el rendimiento.
                \item $\downarrow$ Los modelos de no se ejecutan completamente en la DLA.
            \end{itemize}
        \end{column}
        \begin{column}{0.5\textwidth}
            \begin{center}
    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \begin{itemize}
                ...
                \item Tras un análisis de regresión, se ha encontrado que la cantidad de objetos máxima para que el sistema es capaz de procesar en tiempo real a 30 FPS es de 100 objetos.
            \end{itemize}
        \end{column}
        \begin{column}{0.5\textwidth}
...
\begin{frame}{Resultados - Tipo de segmentación}
    \begin{itemize}
        ...
        \item Se han utilizado el video con una media de 84 objetos.
        \item Para el resto de la configuración se ha utilizado los parámetros más óptimos encontrados en la sección de análisis comparativo.
    \end{itemize}
...
\begin{frame}{Conclusiones -- Cumplimiento de objetivos (1/2)}
...
\begin{frame}{Conclusiones -- Cumplimiento de objetivos (2/2)}
    \begin{itemize}
